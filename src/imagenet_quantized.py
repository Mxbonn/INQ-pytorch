...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.quantize:
        optimizer = src.optim.SGD(model.parameters(), args.lr,
                                  momentum=args.momentum,
                                  weight_decay=args.weight_decay,
    ...
    if args.quantize:
        ...
        quantization_scheduler = src.optim.INQScheduler(optimizer, args.iterative_steps)
    else:
    ...
    for campaign in range(quantization_epochs):
        ...
        }, True, filename='./models/quantized_{}.pth.tar'.format(args.arch))
